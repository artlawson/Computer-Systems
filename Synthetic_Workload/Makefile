...
all:  cache_server test_cache_lib test_cache_client  baseline
...
#benchmarks: cache_client.o benchmarks.o
#	$(CXX) $(LDFLAGS) -o $@ $^ $(LIBS)

baseline: baseline.o cache_client.o 
	$(CXX) $(LDFLAGS) -o $@ $^ $(LIBS)
...
clean:
	rm -rf *.o test_cache_client test_cache_lib cache_server benchmarks baseline
